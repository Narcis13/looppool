...
- [x] Implement "Copy as /lpl:command" button with Clipboard API
...
- [x] Parse and display PROJECT.md with markdown rendering
...
- [x] Add progress summary quick action
...
- [x] Implement d3-force or cytoscape.js with hierarchical positioning
...
- [x] Implement pan with drag behavior
...
- [x] Implement layout persistence in localStorage
...
- [x] Package as single executable using Node.js SEA
