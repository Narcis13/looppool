...
- Example: `/lpl:remove-phase 17` → phase = 17
- Example: `/lpl:remove-phase 16.1` → phase = 16.1

If no argument provided:

```
ERROR: Phase number required
Usage: /lpl:remove-phase <phase-number>
Example: /lpl:remove-phase 17
```
...
To abandon current work, use /lpl:pause-work instead.
```
...
Would you like to:
- `/lpl:progress` — see updated roadmap status
