...
- Example: `/lpl:add-phase Add authentication` → description = "Add authentication"
- Example: `/lpl:add-phase Fix critical performance issues` → description = "Fix critical performance issues"

If no arguments provided:

```
ERROR: Phase description required
Usage: /lpl:add-phase <description>
Example: /lpl:add-phase Add authentication system
```
...
2. Insert new phase heading:
   ...
   **Plans:** 0 plans
   ...
   Plans:
   - [ ] TBD (run /lpl:plan-phase {N} to break down)
...
**Also available:**
- `/lpl:add-phase <description>` — add another phase
- Review roadmap
...
- Don't use decimal numbering (that's /lpl:insert-phase)
- Don't create plans yet (that's /lpl:plan-phase)
