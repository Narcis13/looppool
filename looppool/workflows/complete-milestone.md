...
2. Read `~/.claude/looppool/templates/milestone-archive.md` template
...
**Important:** The next milestone workflow starts with `/lpl:new-milestone` which includes requirements definition. PROJECT.md's Validated section carries the cumulative record across milestones.
...
- [ ] User knows next step (/lpl:new-milestone)
