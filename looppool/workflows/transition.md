...
Exit skill and invoke SlashCommand("/lpl:plan-phase [X+1]")
...
**Also available:**
- `/lpl:discuss-phase [X+1]` — gather context first
- `/lpl:research-phase [X+1]` — investigate unknowns
- Review roadmap
...
Exit skill and invoke SlashCommand("/lpl:complete-milestone {version}")
