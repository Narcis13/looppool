...
│   └── gsd/           # LPL-specific commands
├── looppool/     # Skill resources
...
**New Template:**
- Implementation: `looppool/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `looppool/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/looppool/workflows/{name}.md`

**New Reference Document:**
- Implementation: `looppool/references/{name}.md`
