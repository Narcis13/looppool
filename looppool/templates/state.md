...
**Pending Todos:** Ideas captured via /lpl:add-todo
- Count of pending todos
- Reference to .planning/todos/pending/
- Brief list if few, count if many (e.g., "5 pending todos — see /lpl:check-todos")
...
Used by `/lpl:rollback-phase` to revert all commits in a phase.
